...
export interface DRC20 {
  ...
  drc20_approve: ActorMethod<[Spender, Amount, [] | [Nonce], [] | [Sa], [] | [Data]], TxnResult>;
  drc20_balanceOf: ActorMethod<[Address], Amount>;
  drc20_decimals: ActorMethod<[], number>;
  drc20_dropAccount: ActorMethod<[[] | [Sa]], boolean>;
  drc20_executeTransfer: ActorMethod<[Txid, ExecuteType, [] | [To], [] | [Nonce], [] | [Sa], [] | [Data]], TxnResult>;
  drc20_fee: ActorMethod<[], Amount>;
  drc20_getCoinSeconds: ActorMethod<[[] | [Address]], [CoinSeconds, [] | [CoinSeconds]]>;
  drc20_holdersCount: ActorMethod<[], [bigint, bigint, bigint]>;
  drc20_lockTransfer: ActorMethod<[To, Amount, Timeout, [] | [Decider], [] | [Nonce], [] | [Sa], [] | [Data]], TxnResult>;
  drc20_lockTransferFrom: ActorMethod<[From, To, Amount, Timeout, [] | [Decider], [] | [Nonce], [] | [Sa], [] | [Data]], TxnResult>;
  drc20_metadata: ActorMethod<[], Array<Metadata>>;
  drc20_name: ActorMethod<[], string>;
  drc20_subscribe: ActorMethod<[[Principal, string], Array<MsgType>, [] | [Sa]], boolean>;
  drc20_subscribed: ActorMethod<[Address], [] | [Subscription]>;
  drc20_symbol: ActorMethod<[], string>;
  drc20_totalSupply: ActorMethod<[], Amount>;
  drc20_transfer: ActorMethod<[To, Amount, [] | [Nonce], [] | [Sa], [] | [Data]], TxnResult>;
  drc20_transferFrom: ActorMethod<[From, To, Amount, [] | [Nonce], [] | [Sa], [] | [Data]], TxnResult>;
...
export type MsgType = { onApprove: null } | { onExecute: null } | { onTransfer: null } | { onLock: null };
