export default ({ IDL }: {IDL:any}) => {
  ...
  const DRC20 = IDL.Service({
    ...
    drc20_approve: IDL.Func([Spender, Amount, IDL.Opt(Nonce), IDL.Opt(Sa), IDL.Opt(Data)], [TxnResult], []),
    ...
    drc20_executeTransfer: IDL.Func([Txid, ExecuteType, IDL.Opt(To), IDL.Opt(Nonce), IDL.Opt(Sa), IDL.Opt(Data)], [TxnResult], []),
    drc20_fee: IDL.Func([], [Amount], ['query']),
    drc20_getCoinSeconds: IDL.Func([IDL.Opt(Address)], [CoinSeconds, IDL.Opt(CoinSeconds)], ['query']),
    drc20_holdersCount: IDL.Func([], [IDL.Nat, IDL.Nat, IDL.Nat], ['query']),
    drc20_lockTransfer: IDL.Func([To, Amount, Timeout, IDL.Opt(Decider), IDL.Opt(Nonce), IDL.Opt(Sa), IDL.Opt(Data)], [TxnResult], []),
    drc20_lockTransferFrom: IDL.Func([From, To, Amount, Timeout, IDL.Opt(Decider), IDL.Opt(Nonce), IDL.Opt(Sa), IDL.Opt(Data)], [TxnResult], []),
    drc20_metadata: IDL.Func([], [IDL.Vec(Metadata)], ['query']),
    drc20_name: IDL.Func([], [IDL.Text], ['query']),
    drc20_subscribe: IDL.Func([Callback, IDL.Vec(MsgType), IDL.Opt(Sa)], [IDL.Bool], []),
    ...
    drc20_transfer: IDL.Func([To, Amount, IDL.Opt(Nonce), IDL.Opt(Sa), IDL.Opt(Data)], [TxnResult], []),
    drc20_transferFrom: IDL.Func([From, To, Amount, IDL.Opt(Nonce), IDL.Opt(Sa), IDL.Opt(Data)], [TxnResult], []),
